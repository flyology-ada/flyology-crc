...
private package Flyology_CRC.CRC32_ISO_HDLC_PMULL_EOR3_V9S3X2E_S3 is
   use type Interfaces.Unsigned_32;

   --  State is the raw reflected CRC register before Final_XOR.  The caller
   --  must establish AArch64 CRC32, PMULL, and SHA3 availability before
   --  calling with nonempty data.  Empty input is an identity operation; the
