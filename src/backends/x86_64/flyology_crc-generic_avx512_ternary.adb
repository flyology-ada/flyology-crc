...
--  AVX-512F/VL ternary and PCLMULQDQ implementation; dispatch and suffix
--  policy remain in Ada callers compiled for baseline x86-64. See
--  THIRD_PARTY_NOTICES.md for the folding and reduction provenance.

with Flyology_CRC.Generic_PMULL_Kernel;
with System.Machine_Code;
with System.Storage_Elements;

package body Flyology_CRC.Generic_AVX512_Ternary is
   ...
   pragma Compile_Time_Error
     (System.Default_Bit_Order /= System.Low_Order_First,
      "the x86-64 generic AVX-512 ternary CRC backend requires little-endian byte order");
   pragma Compile_Time_Error
     (System.Word_Size /= 64,
      "the x86-64 generic AVX-512 ternary CRC backend requires 64-bit words");
   pragma Compile_Time_Error
     (Vector_128'Size /= 128,
      "the x86-64 generic AVX-512 ternary CRC vector must be exactly 128 bits");
   ...
   procedure Fold_Stripes_8
     (Source      : in out System.Address;
      ...
      --  This fixed arithmetic value is not dispatch policy.
      ...
      Forward_Template : constant String :=
        ...
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %1" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %1" & ASCII.LF & ASCII.HT &
        "movdqu 16(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %2, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %2" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %2" & ASCII.LF & ASCII.HT &
        "movdqu 32(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %3, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %3" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %3" & ASCII.LF & ASCII.HT &
        "movdqu 48(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %4, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %4" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %4" & ASCII.LF & ASCII.HT &
        "movdqu 64(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %5, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %5" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %5" & ASCII.LF & ASCII.HT &
        "movdqu 80(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %6, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %6" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %6" & ASCII.LF & ASCII.HT &
        "movdqu 96(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %7, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %7" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %7" & ASCII.LF & ASCII.HT &
        "movdqu 112(%0), %%xmm1" & ASCII.LF & ASCII.HT &
        "pshufb %11, %%xmm1" & ASCII.LF & ASCII.HT &
        "movdqa %8, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $0, %10, %%xmm0" & ASCII.LF & ASCII.HT &
        "pclmulqdq $17, %10, %8" & ASCII.LF & ASCII.HT &
        "vpternlogq $0x96, %%xmm1, %%xmm0, %8" & ASCII.LF & ASCII.HT &
        "addq $128, %0" & ASCII.LF & ASCII.HT &
        "cmpq %9, %0" & ASCII.LF & ASCII.HT &
        "jne 1b";
   begin
         ...
         when 12 =>
            Asm
              (Template => "pslldq $12, %0",
               ...
               Volatile => True);
         when others =>
            raise Program_Error with "unsupported x86 AVX-512 byte shift";
      end case;
      return Result;
   end Shift_Left;
   ...
   begin
      return AVX512_16.Update_Aligned_Blocks (State, Reflected, Keys, Data);
   end Update_16;
   ...
   begin
      return AVX512_32.Update_Aligned_Blocks (State, Reflected, Keys, Data);
   end Update_32;
   ...
   begin
      return AVX512_64.Update_Aligned_Blocks (State, Reflected, Keys, Data);
   end Update_64;
