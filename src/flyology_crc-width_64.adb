...
package body Flyology_CRC.Width_64 is
   use type Value;
   ...
   begin
      if Data'Length = 1_024
        and then Configuration.Reflected
        and then Native_Features.PMULL_64_1024_Reflected_Preferred
      then
         State :=
           Native.Update_PMULL_64_1024_Reflected
             (State, Configuration.Keys, Data (Data'First)'Address);
      elsif Data'Length >= 128
        and then
      ...
      then
         ...
         begin
            ...
            then
               State :=
                 Generic_AVX512_VPCLMUL.Update_64
            ...
            then
               State :=
                 Generic_AVX512_Ternary.Update_64
                   (State, Configuration.Reflected, Configuration.Keys, Folded);
   ...
   function Compute_NVME (Data : Byte_Array) return Value is
   begin
      return Compute (NVME, Data);
   end Compute_NVME;
